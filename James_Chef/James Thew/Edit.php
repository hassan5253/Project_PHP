...
if(isset($_POST['btnupdate']))
{
	...
	$CN=mysql_connect("localhost","root","");
		...
		mysql_query("update tblmember set UName='$UN',Password='$PW',Confirm Pass='$CPW',Email='$EM',Gender='$GN',Country='$CO',Charges='$CH' where UID='$UID' ",$CN);
		mysql_close($CN);
		echo "Data Saved...";
...
<table width="350" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#F4FAFF" style="border:1px solid #0099FF;">
  <tr>
    <td colspan="2" class="heading" align="center" style="border-bottom:1px solid #0099FF;"> - UPDATE - </td>
  </tr>
  <tr>
...
<td><input type="radio" name="Payment" value="monthly" class="required"  />10$ (Monthly)
  ...
  <tr>
  <td align="left" ><a href="Profile.php">Back</a></td>
